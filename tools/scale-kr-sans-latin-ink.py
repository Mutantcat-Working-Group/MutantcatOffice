#!/usr/bin/env python3
"""Scale MutantcatOffice Sans KR Latin outlines to Malgun Gothic's ink boxes.
...
DEFAULT = "apps/docs/src/renderer/fonts/MutantcatOfficeSansKR-Regular-subset.woff2"
