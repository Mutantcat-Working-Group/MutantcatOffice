#!/usr/bin/env python3
"""Build MutantcatOffice Tamil from upstream Noto Sans Tamil, hmtx-normalized to Latha.
...
DEFAULT_OUT = "apps/docs/src/renderer/fonts/MutantcatOfficeTamil-Regular.woff2"
FAMILY = "MutantcatOffice Tamil"
...
def main() -> None:
    ...
    rename(font, FAMILY, "MutantcatOfficeTamil-Regular")
    space = cmap.get(0x20)
