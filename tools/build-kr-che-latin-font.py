#!/usr/bin/env python3
"""Build MutantcatOffice Che Latin KR: half-width Latin for -Che fixed-pitch faces.
...
ASCII-only face from the MutantcatOffice Sans KR outlines (Noto-derived, OFL),
...
SOURCE = "apps/docs/src/renderer/fonts/MutantcatOfficeSansKR-Regular-subset.woff2"
DEFAULT_OUT = "apps/docs/src/renderer/fonts/MutantcatOfficeCheLatinKR.woff2"
DOTUMCHE = ("/Applications/Microsoft Word.app/Contents/Resources/DFonts/gulim.ttc", 3)
FAMILY = "MutantcatOffice Che Latin KR"
PS_NAME = "MutantcatOfficeCheLatinKR"
