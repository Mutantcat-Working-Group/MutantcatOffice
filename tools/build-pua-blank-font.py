#!/usr/bin/env python3
"""Build MutantcatOffice PUA Blank: every BMP Private Use codepoint maps to one
blank 1em glyph.
...
DEFAULT_OUT = "apps/docs/src/renderer/fonts/MutantcatOfficePUABlank.woff2"
FAMILY = "MutantcatOffice PUA Blank"
UPM = 1000
