#!/usr/bin/env python3
"""Build MutantcatOffice Poppins from upstream Poppins, metrics untouched.
...
FAMILY = "MutantcatOffice Poppins"
PS_FAMILY = "MutantcatOfficePoppins"
...
def main() -> None:
    ...
    default_out = root / OUT_DIR / f"MutantcatOfficePoppins-{subfamily}-subset.woff2"
