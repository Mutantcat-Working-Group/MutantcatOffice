#!/usr/bin/env python3
"""Normalize MutantcatOffice Serif KR Latin metrics to Batang.
...
from Word on those documents. MutantcatOffice Sans KR already went through the
same treatment for Malgun (normalize-kr-sans-hmtx.py +
scale-kr-sans-latin-ink.py). MutantcatOffice Gothic KR is out of scope: it models
...
TARGETS = {
    "MutantcatOfficeSerifKR-Regular-subset.woff2": ("batang.ttc", 0),  # Batang
}
