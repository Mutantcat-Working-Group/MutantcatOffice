<p align="center">
  <a href="https://genoffice.ai/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="MutantcatOffice – die Open-Source-KI-Office-Suite: Docs, Sheets, Slides, PDF, Markdown und HTML mit integriertem KI-Panel" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/Mutantcat-Working-Group/MutantcatOffice" alt="Lizenz: Apache-2.0"></a>
  <a href="https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest"><img src="https://img.shields.io/github/v/release/Mutantcat-Working-Group/MutantcatOffice" alt="Neueste Version"></a>
  ...
  <a href="https://github.com/Mutantcat-Working-Group/MutantcatOffice/stargazers"><img src="https://img.shields.io/github/stars/Mutantcat-Working-Group/MutantcatOffice?style=flat" alt="GitHub-Sterne"></a>
</p>
...
MutantcatOffice ist eine kostenlose Open-Source-Alternative zu Microsoft Office für
...
- **Deine Schlüssel oder keine.** Melde dich mit MutantcatOffice an und du brauchst
...
**Los geht's:** [macOS](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest) (Apple Silicon und Intel) ·
[Windows](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest) (x64 und Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="MutantcatOffice Docs stellt eine zweispaltige Geschäftsberichtsseite mit vollbreitem Titelbild, schattierter KPI-Tabelle, Kopf- und Fußzeile bei 80 % Zoom mit eingeklapptem KI-Panel dar"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="MutantcatOffice Docs: eine Unternehmensübersicht mit einem Banner-Bild; die KI hat die Übersicht gestrafft und einen neuen Abschnitt mit Aufzählungspunkten eingefügt, und das Panel bietet ein Rückgängig per Klick"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="MutantcatOffice Sheets: die KI hat ein Summary-Tabellenblatt mit Umsatz nach Region und Kategorie über SUMIF-Formeln sowie ein Säulendiagramm hinzugefügt und meldet 43 angewendete Änderungen mit einer Rückgängig-Schaltfläche"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="MutantcatOffice Sheets: auf die Frage, welche Region den Q2-Umsatz anführte, antwortet die KI mit Europa samt Aufschlüsselung nach Kategorie und verlinkt die verwendeten Zellen als Belege, neben dem Orders-Tabellenblatt"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Zeitraffer von MutantcatOffice Slides bei der Erstellung des Investoren-Decks für Aurora Home: Die KI plant die Storyline im Panel, die Folien erscheinen nacheinander auf der Leinwand, und das fertige Deck endet mit dem abschließenden Ask" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="MutantcatOffice Slides: die Titelfolie einer von der KI erstellten Investoren-Präsentation für Aurora Home auf der Arbeitsfläche, mit dem ursprünglichen Ein-Zeilen-Prompt und der Zusammenfassung der KI im Panel, was sie erstellt hat"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="MutantcatOffice Slides: die gestaltete Abschlussfolie derselben 11-Folien-Präsentation, mit der Miniaturansicht-Leiste links und dem KI-Panel, das den Handlungsbogen zusammenfasst"></td>
</tr>
<tr>
<td><b>Eine Zeile rein</b> — „Erstelle eine 10-Folien-Investoren-Präsentation für Aurora Home…“. MutantcatOffice plant den Handlungsbogen, recherchiert die Zahlen und entwirft jede Folie direkt auf der Arbeitsfläche als echte <code>.pptx</code>.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="MutantcatOffice PDF: Der Textbearbeitungsmodus umrahmt jeden Textblock auf der Seite zur direkten Bearbeitung, während das KI-Panel eine Frage zum Bericht mit Seitenangaben beantwortet"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="MutantcatOffice Docs zeigt ein Word-Dokument, das lokal aus dem PDF des Helios-Quartalsberichts konvertiert wurde, geöffnet in einem zweiten Tab neben dem Original-PDF"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Zeitraffer von MutantcatOffice HTML beim Neugestalten der Lumen-Landingpage: Eine einzige Restyle-Anfrage im Panel verwandelt die dunkle Midnight Studio-Seite in die warme Solar Daybreak-Version, während jeder Abschnitt und der gesamte Text unverändert bleiben" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="MutantcatOffice HTML: eine generierte Landingpage für eine Solar-Schreibtischlampe in der dunklen Stilrichtung „Midnight Studio“, gezeigt in der Live-Vorschau mit dem KI-Panel, das die gerade erstellte Seite zusammenfasst"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="MutantcatOffice HTML: ein generiertes persönliches Dashboard-UI für eine freiberufliche Designerin im warmen Leinen-Stil, mit einer linken Leiste, einer Begrüßung in Serifenschrift und vier Kennzahlen-Karten"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="MutantcatOffice HTML: ein generierter Datenreport zum E-Auto-Markt im Broadsheet-Stil, mit einem Serifen-Kopf, einer Schlagzeile von 17,3 Millionen und einer Kennzahlenzeile"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="MutantcatOffice Markdown: In einem ausgewählten Absatz erscheint ein Ask-AI-Popover mit einer eingegebenen Anweisung und Vorschlags-Chips wie „Polish“, „Make more concise“, „Expand“ und „Fix grammar“, außerdem den Schaltflächen „Send now“ und „Add to queue“"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="MutantcatOffice Markdown stellt ein Launch-Notes-Dokument mit einer Tabelle, einem Mermaid-Flussdiagramm und einer Aufgabenliste dar, mit den Start-Prompts des KI-Panels links"></td>
</tr>
<tr>
...
### 7 · CLI – dein Coding-Agent steuert MutantcatOffice, auf deinem Rechner

MutantcatOffice bringt eine `genoffice`-Befehlszeile und einen Agent-Skill mit.
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="MutantcatOffice Slides zeigt eine Sonnensystem-Präsentation mit acht Folien, die ein Coding-Agent über die genoffice-Befehlszeile erstellt hat: die Titelfolie auf der Arbeitsfläche, acht Miniaturansichten links und das geöffnete KI-Panel" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="MutantcatOffice-Einstellungen, Seite Integrationen: der genoffice-Skill ist in Claude Code installiert, mit Installieren-Schaltflächen neben Codex und Cursor"></td>
</tr>
<tr>
...
<td><b>Einmal installieren, unter Einstellungen → Integrationen</b> — MutantcatOffice listet die Coding-Agenten auf, die es auf diesem Rechner findet, und schreibt den Skill in jeden, den du auswählst. Oder lade den Skill als Zip herunter oder führe <code>npx skills add Mutantcat-Working-Group/MutantcatOffice</code> aus. Befehle und der vollständige Workflow stehen unter <a href="#command-line-and-agent-skill">Befehlszeile und Agent-Skill</a>.</td>
</tr>
</table>
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Zeitraffer von Claude Code beim Bau einer achtseitigen Investoren-Präsentation über erneuerbare Energien über den genoffice-MCP-Server: sucht nach Abbildungen und Fotos, prüft jedes Kandidatenbild mit media, deck_start schreibt das Stylesheet und die Gliederung, deck_page fügt Seite für Seite eine geprüfte Seite hinzu, deck_build stellt die .pptx zusammen und slides_render liefert ein Bild jeder Folie zurück; die fertige Präsentation öffnet sich danach in MutantcatOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="MutantcatOffice Slides zeigt die achtseitige Präsentation Renewable Energy 2026, die Claude Code über den genoffice-MCP-Server erstellt hat: die Titelfolie mit einem Foto eines Windparks auf der Arbeitsfläche und acht Miniaturansichten links"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="MutantcatOffice-Einstellungen, Seite Integrationen, MCP-Teil: der einzeilige claude mcp add-Befehl für Claude Code, der JSON-Block für Cursor, Claude Desktop und andere MCP-Clients, und die Option für den lokalen HTTP-Server darunter"></td>
</tr>
<tr>
...
- **Dein Modell, dein Schlüssel.** Bringe deinen eigenen API-Key oder nutze MutantcatOffice
...
**Mit MutantcatOffice anmelden**, und es gibt nichts zu konfigurieren:
Modellaufrufe laufen über den MutantcatOffice-Proxy (die Modellfamilien Claude, GPT
...
bearbeiten – auf denselben Engines, ohne Fenster. Sie wird mit MutantcatOffice
...
| Wie                                                      | Was passiert                                                                                                                                                                                                                   |
| -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Einstellungen → Integrationen** in der App             | Listet die auf diesem Rechner gefundenen Agenten auf; ein Klick schreibt den Skill in jeden, den du auswählst. Eine **Aktualisieren**-Schaltfläche erscheint, wenn eine MutantcatOffice-Version einen neueren Skill mitbringt. |
...
| `npx skills add Mutantcat-Working-Group/MutantcatOffice` | Installiert aus diesem Repository in jeden Skills-kompatiblen Agenten.                                                                                                                                                         |
...
die CLI baut und prüft, und das Ergebnis öffnet sich in MutantcatOffice oder
...
`/Applications/MutantcatOffice.app/Contents/Resources/cli/genoffice`; der
...
`image`, `media`) laufen weiterhin über den in MutantcatOffice konfigurierten
...
`search` und `media` haben die Maschine verlassen, zum in MutantcatOffice
...
| ------------------------------------ | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| **macOS** – Apple Silicon (arm64)    | macOS 11+                                             | [Neueste `.dmg` (arm64)](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)          |
| **macOS** – Intel (x64)              | macOS 11+                                             | [Neueste `.dmg` (x64)](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)            |
| **Windows** (x64, die meisten PCs)   | Windows 10+, Intel/AMD                                | [Neuester `-x64.exe`-Installer](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)   |
| **Windows** auf Arm (ARM64)          | Windows 11 auf Arm (Snapdragon X und Ähnliche)        | [Neuester `-arm64.exe`-Installer](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest) |
| **Linux** – Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 oder neuer)         | [Neueste `.deb`](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)                  |
| **Linux** – Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Neueste `.rpm`](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)                  |
| **Linux** – andere Distributionen    | x86_64, glibc 2.34+, FUSE 2                           | [Neueste `.AppImage`](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)             |
...
und fügt MutantcatOffice dem Anwendungsmenü hinzu:
...
xlsx-Sidecar (`cargo` im PATH); `npm run build -w @mutantcatoffice/sheets`
kompiliert ihn automatisch.

## Community

MutantcatOffice wird aktiv weiterentwickelt, und dein Feedback prägt es mit.
...
- **Tritt dem MutantcatOffice-Gruppenchat** auf
  [GenTeam](https://genoffice.ai/join) bei, um mit dem Team und anderen
  Nutzern zu sprechen.
- **Gib dem Repo einen Stern**, wenn dir MutantcatOffice nützlich ist – das ist
  die beste Art, das Projekt zu unterstützen.

## FAQ

<details>
<summary><b>Ist MutantcatOffice kostenlos?</b></summary>

Ja. MutantcatOffice ist kostenlos und Open Source unter der Apache-2.0-Lizenz –
keine Testversion, keine kostenpflichtige Stufe für die Apps selbst.

</details>

<details>
<summary><b>Kann MutantcatOffice Microsoft Word-, Excel- und PowerPoint-Dateien öffnen?</b></summary>

Ja. MutantcatOffice öffnet und speichert native `.docx`-, `.xlsx`- und
...
<details>
<summary><b>Funktioniert MutantcatOffice offline?</b></summary>
...
Netzwerkverbindung, entweder über MutantcatOffice oder deinen
eigenen Modell-API-Schlüssel.

</details>

<details>
<summary><b>Kann MutantcatOffice PDF-Dateien bearbeiten?</b></summary>
...
<details>
<summary><b>Kann MutantcatOffice PDF in Word, Excel oder PowerPoint konvertieren?</b></summary>
...
Ja. Neben MutantcatOffice unterstützt das
...
<details>
<summary><b>Kann MutantcatOffice HTML in Word konvertieren?</b></summary>
...
<details>
<summary><b>Kann ich MutantcatOffice aus Claude Code, Codex, Cursor oder einem Skript steuern?</b></summary>

Ja. MutantcatOffice installiert eine `genoffice`-Befehlszeile, die dieselben
...
<details>
<summary><b>Erfasst MutantcatOffice irgendwelche Daten?</b></summary>
...
[MutantcatOffice-Datenschutz](../../PRIVACY.md).
...
MutantcatOffice wäre ohne diese Open-Source-Projekte nicht möglich:
...
MutantcatOffice steht unter der [Apache License 2.0](../../LICENSE), mit einer
...
Die Namen und Logos von MutantcatOffice sind Marken von Mainfunc, Inc.
