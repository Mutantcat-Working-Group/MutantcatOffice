<p align="center">
  <a href="https://genoffice.ai/">
    <picture>
      ...
      <img src="../assets/readme/hero.webp" alt="MutantcatOffice — свободный AI-офисный пакет с открытым исходным кодом: Docs, Sheets, Slides, PDF, Markdown и HTML со встроенной AI-панелью" width="100%">
    </picture>
  </a>
</p>
...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/Mutantcat-Working-Group/MutantcatOffice" alt="Лицензия: Apache-2.0"></a>
  <a href="https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest"><img src="https://img.shields.io/github/v/release/Mutantcat-Working-Group/MutantcatOffice" alt="Последний релиз"></a>
  <a href="https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases"><img src="https://img.shields.io/github/downloads/Mutantcat-Working-Group/MutantcatOffice/total" alt="Загрузки"></a>
  <a href="https://github.com/Mutantcat-Working-Group/MutantcatOffice/stargazers"><img src="https://img.shields.io/github/stars/Mutantcat-Working-Group/MutantcatOffice?style=flat" alt="Звёзды на GitHub"></a>
</p>
...
MutantcatOffice — бесплатная альтернатива Microsoft Office с открытым исходным
...
- **Свои ключи или никаких.** Войдите через Mutantcat AI и обойдитесь без ключей
...
**Скачать:** [macOS](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest) (Apple Silicon и Intel) ·
[Windows](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest) (x64 и Arm) ·
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/docs-report.webp" alt="MutantcatOffice Docs отображает страницу годового отчёта в две колонки с полноширинным изображением на обложке, затемнённой таблицей KPI, верхним и нижним колонтитулами при масштабе 80% и свёрнутой AI-панелью"></td>
<td width="50%"><img src="../assets/readme/docs-ai.webp" alt="MutantcatOffice Docs: обзор компании с изображением-баннером; AI сократил раздел Overview и добавил новый раздел со списком, а панель предлагает откат одним щелчком"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/sheets-ai.webp" alt="MutantcatOffice Sheets: AI добавил лист Summary с доходом по регионам и категориям на формулах SUMIF, плюс столбчатую диаграмму, и сообщает о 43 применённых изменениях с кнопкой отмены"></td>
<td width="50%"><img src="../assets/readme/sheets-qa.webp" alt="MutantcatOffice Sheets: на вопрос о том, какой регион лидировал по доходу во втором квартале, AI отвечает «Европа» с разбивкой по категориям и указывает точные ячейки как ссылки-цитаты, рядом с листом Orders"></td>
</tr>
<tr>
...
<img src="../assets/readme/slides-generate.webp" alt="Таймлапс создания презентации MutantcatOffice Slides для инвесторской колоды Aurora Home: ИИ планирует сюжет в панели, слайды появляются на холсте один за другим, а готовая презентация завершается финальным призывом к действию" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/slides-cover.webp" alt="MutantcatOffice Slides: титульный слайд презентации для инвесторов Aurora Home, созданной AI, на холсте, с исходным однострочным промптом и резюме AI о том, что было построено, на панели"></td>
<td width="50%"><img src="../assets/readme/slides-ai.webp" alt="MutantcatOffice Slides: оформленный финальный слайд той же презентации из 11 слайдов, с полосой миниатюр слева и AI-панелью, подытоживающей сюжетную линию"></td>
</tr>
<tr>
<td><b>Одна строка на входе</b> — «Создай презентацию для инвесторов из 10 слайдов для Aurora Home…». MutantcatOffice выстраивает сюжетную линию, собирает цифры и создаёт каждый слайд прямо на холсте как настоящий файл <code>.pptx</code>.</td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/pdf-edit.webp" alt="MutantcatOffice PDF: режим редактирования текста обводит каждый текстовый блок на странице для редактирования на месте, а AI-панель отвечает на вопрос об отчёте со ссылками на страницы"></td>
<td width="50%"><img src="../assets/readme/pdf-convert.webp" alt="MutantcatOffice Docs показывает документ Word, конвертированный локально из квартального отчёта Helios в формате PDF, открытый во второй вкладке рядом с исходным PDF"></td>
</tr>
<tr>
...
<img src="../assets/readme/html-restyle-motion.webp" alt="Таймлапс изменения стиля MutantcatOffice HTML для лендинга Lumen: один запрос Restyle в панели превращает тёмную страницу Midnight Studio в тёплую версию Solar Daybreak, при этом все разделы и весь текст остаются на месте" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/html-ai.webp" alt="MutantcatOffice HTML: сгенерированный лендинг для настольной лампы на солнечных батареях в тёмном направлении Midnight Studio, показанный в живом предпросмотре, с AI-панелью, резюмирующей только что созданную страницу"></td>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/html-dashboard.webp" alt="MutantcatOffice HTML: сгенерированный интерфейс личного дашборда для дизайнера-фрилансера в тёплом «льняном» стиле, с боковой панелью, серифным приветствием и четырьмя карточками показателей"></td>
<td width="50%"><img src="../assets/readme/html-report.webp" alt="MutantcatOffice HTML: сгенерированный отчёт о рынке электромобилей в стиле широкоформатной газеты, с серифной шапкой, заголовной цифрой 17,3 миллиона и строкой статистики"></td>
</tr>
<tr>
...
<table>
<tr>
<td width="50%"><img src="../assets/readme/markdown-ai.webp" alt="MutantcatOffice Markdown: у выделенного абзаца всплывает окно Ask AI с введённой инструкцией и чипами-подсказками, такими как «Отполировать», «Сделать короче», «Развернуть» и «Исправить грамматику», а также кнопками «Отправить сейчас» и «Добавить в очередь»"></td>
<td width="50%"><img src="../assets/readme/markdown-render.webp" alt="MutantcatOffice Markdown отображает документ с заметками о релизе, содержащий таблицу, блок-схему Mermaid и список задач, со стартовыми промптами AI-панели слева"></td>
</tr>
<tr>
...
### 7 · CLI — ваш кодинг-агент управляет MutantcatOffice на вашем компьютере

В MutantcatOffice входит командная строка `genoffice` и агентный скилл. Установите
...
<img src="../assets/readme/cli-deck-in-app.webp" alt="MutantcatOffice Slides показывает презентацию о Солнечной системе из восьми слайдов, которую кодинг-агент собрал через командную строку genoffice: титульный слайд на холсте, восемь миниатюр слева и открытая AI-панель" width="100%">
...
<td width="50%"><img src="../assets/readme/cli-integrations.webp" alt="MutantcatOffice Settings, страница Integrations: скилл genoffice установлен в Claude Code, рядом с Codex и Cursor — кнопки Install"></td>
</tr>
<tr>
...
<td><b>Установите один раз, через Настройки → Интеграции</b> — MutantcatOffice перечисляет кодинг-агентов, найденных на этом компьютере, и записывает скилл в каждый выбранный вами. Либо скачайте скилл в виде zip или выполните <code>npx skills add Mutantcat-Working-Group/MutantcatOffice</code>. Команды и полный рабочий процесс — в разделе <a href="#command-line-and-agent-skill">Командная строка и агентный скилл</a>.</td>
</tr>
</table>
...
<img src="../assets/readme/mcp-deck-motion.webp" alt="Ускоренная съёмка того, как Claude Code строит восьмислайдовую презентацию для инвесторов о возобновляемой энергетике через MCP-сервер genoffice: ищет иллюстрации и фотографии, проверяет каждую фотографию-кандидата с помощью media, deck_start пишет таблицу стилей и план, deck_page добавляет по одной проверенной странице за раз, deck_build собирает .pptx и slides_render возвращает изображение каждого слайда; готовая презентация затем открывается в MutantcatOffice Slides" width="100%">

<table>
<tr>
<td width="50%"><img src="../assets/readme/mcp-deck-in-app.webp" alt="MutantcatOffice Slides показывает восьмислайдовую презентацию Renewable Energy 2026, которую Claude Code построил через MCP-сервер genoffice: титульный слайд с фотографией ветропарка на холсте и восемь миниатюр слева"></td>
<td width="50%"><img src="../assets/readme/mcp-integrations.webp" alt="MutantcatOffice Settings, страница Integrations, часть MCP: однострочная команда claude mcp add для Claude Code, JSON-блок для Cursor, Claude Desktop и других MCP-клиентов, и опция локального HTTP-сервера ниже"></td>
</tr>
<tr>
...
- **Своя модель, свой ключ.** Войдите через Mutantcat AI или используйте свой
...
**Войдите через Mutantcat AI** — и настраивать ничего не нужно: вызовы моделей
идут через проксирующий сервис Mutantcat AI (семейства Claude, GPT и Gemini), а
...
без графического интерфейса. Она устанавливается вместе с MutantcatOffice, не
...
| Как                                                      | Что происходит                                                                                                                                                                         |
| -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Настройки → Интеграции** в приложении                  | Показывает агентов, найденных на этом компьютере; один клик записывает скилл в каждый выбранный. Когда релиз MutantcatOffice приносит более новый скилл, появляется кнопка **Update**. |
...
| `npx skills add Mutantcat-Working-Group/MutantcatOffice` | Устанавливает скилл из этого репозитория в любой агент, поддерживающий скиллы.                                                                                                         |
...
собирает и проверяет, а результат открывается в MutantcatOffice или PowerPoint как
обычный `.pptx`.
...
`/Applications/MutantcatOffice.app/Contents/Resources/cli/genoffice`; панель
...
провайдера, настроенного в MutantcatOffice; всё остальное выполняется локально, а
...
`media` покидали машину — к провайдеру, настроенному в MutantcatOffice.
...
| ------------------------------------ | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [Последний `.dmg` (arm64)](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)          |
| **macOS** — Intel (x64)              | macOS 11+                                             | [Последний `.dmg` (x64)](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)            |
| **Windows** (x64, большинство ПК)    | Windows 10+, Intel/AMD                                | [Последний установщик `-x64.exe`](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)   |
| **Windows** на Arm (ARM64)           | Windows 11 на Arm (Snapdragon X и аналогичные)        | [Последний установщик `-arm64.exe`](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest) |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 или новее)          | [Последний `.deb`](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)                  |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [Последний `.rpm`](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)                  |
| **Linux** — другие дистрибутивы      | x86_64, glibc 2.34+, FUSE 2                           | [Последний `.AppImage`](https://github.com/Mutantcat-Working-Group/MutantcatOffice/releases/latest)             |
...
добавляет MutantcatOffice в меню приложений:
...
(`cargo` в PATH); команда `npm run build -w @mutantcatoffice/sheets` собирает его
автоматически.

## Сообщество

MutantcatOffice активно развивается, и ваши отзывы влияют на его развитие.

- **Сообщите об ошибке или предложите функцию** в
  [GitHub Issues](https://github.com/Mutantcat-Working-Group/MutantcatOffice/issues).
- **Присоединяйтесь к групповому чату MutantcatOffice** в
  [GenTeam](https://genoffice.ai/join), чтобы общаться с командой и другими
  пользователями.
- **Поставьте звезду репозиторию**, если MutantcatOffice вам полезен — это лучший
  способ поддержать проект.

## Часто задаваемые вопросы

<details>
<summary><b>MutantcatOffice бесплатен?</b></summary>

Да. MutantcatOffice бесплатен и распространяется с открытым исходным кодом по
...
<details>
<summary><b>Может ли MutantcatOffice открывать файлы Microsoft Word, Excel и PowerPoint?</b></summary>

Да. MutantcatOffice открывает и сохраняет нативные файлы `.docx`, `.xlsx` и
...
<details>
<summary><b>Работает ли MutantcatOffice офлайн?</b></summary>
...
к сети — либо через вход в Mutantcat AI, либо через ваш собственный ключ API
модели.

</details>

<details>
<summary><b>Может ли MutantcatOffice редактировать файлы PDF?</b></summary>
...
<details>
<summary><b>Может ли MutantcatOffice конвертировать PDF в Word, Excel или PowerPoint?</b></summary>
...
Да. Помимо входа через Mutantcat AI без ключей, MutantcatOffice поддерживает
...
<details>
<summary><b>Может ли MutantcatOffice конвертировать HTML в Word?</b></summary>
...
<details>
<summary><b>Могу ли я управлять MutantcatOffice из Claude Code, Codex, Cursor или скрипта?</b></summary>

Да. MutantcatOffice устанавливает командную строку `genoffice`, которая запускает те
...
<details>
<summary><b>Собирает ли MutantcatOffice какие-либо данные?</b></summary>
...
MutantcatOffice был бы невозможен без этих проектов с открытым исходным кодом:
...
MutantcatOffice распространяется по лицензии [Apache License 2.0](../../LICENSE),
с одним исключением: каталог `ee/` зарезервирован для будущих корпоративных
модулей и покрывается [MutantcatOffice Enterprise License](../../ee/LICENSE).

Названия и логотипы MutantcatOffice и Mutantcat AI являются товарными знаками Mainfunc,
