...
import { openPptx, savePptx, type TextElement } from '@mutantcatoffice/pptx-engine'
import { buildRenderSlide, EMU_PER_PX_96, type RenderSlide } from '@mutantcatoffice/pptx-render'
import {
  fillToKonva,
  glyphToDraw,
  presetToShapeKind,
