...
import { showOpenDialogWithMemory } from '@mutantcatoffice/electron-utils'
...
/** office/pdf formats extract text via @mutantcatoffice/file-parse; images skip text extraction and go multimodal (slides:files-read-image) */
...
/** Extract attachment text via @mutantcatoffice/file-parse (docx/pdf/pptx/xlsx/plain text) */
