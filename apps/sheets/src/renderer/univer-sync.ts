...
import { splitSheetRef, type CellBounds } from '@mutantcatoffice/xlsx-gateway/domain/chart-visual'
...
import { WORST_FIRST_ICON_SETS } from '@mutantcatoffice/xlsx-gateway/gateway/xlsx-cf'
import type {
  CellFormatState,
  CellScalar,
  CellState,
