...
export const ja = {
  ...
  aiMutantcatAccount: 'Mutantcat AI アカウント',
  aiAccountChecking: '確認中…',
  aiLoggedIn: 'サインイン済み',
  aiLoggedInAs: 'サインイン済み: {email}',
  aiNotLoggedIn: '未サインイン（AI 機能には Mutantcat AI アカウントへのサインインが必要です）',
  ...
  aiCreditsExhausted:
    'Mutantcat AIクレジットを使い切りました。mutantcat.ai/pricing でチャージしてから再試行してください',
