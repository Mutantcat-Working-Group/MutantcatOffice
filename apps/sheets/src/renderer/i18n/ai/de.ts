...
export const de = {
  ...
  aiMutantcatAccount: 'Mutantcat AI-Konto',
  aiAccountChecking: 'Wird überprüft…',
  aiLoggedIn: 'Angemeldet',
  aiLoggedInAs: 'Angemeldet: {email}',
  aiNotLoggedIn: 'Nicht angemeldet (KI-Funktionen erfordern ein Mutantcat AI-Konto)',
  ...
  aiCreditsExhausted:
    'Deine Mutantcat AI-Credits sind aufgebraucht. Lade unter mutantcat.ai/pricing auf und versuche es erneut',
