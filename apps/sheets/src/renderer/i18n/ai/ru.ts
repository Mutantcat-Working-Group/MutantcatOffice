...
export const ru = {
  ...
  aiMutantcatAccount: 'Учётная запись Mutantcat AI',
  aiAccountChecking: 'Проверка…',
  aiLoggedIn: 'Вход выполнен',
  aiLoggedInAs: 'Вход выполнен: {email}',
  aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись Mutantcat AI)',
  ...
  aiCreditsExhausted:
    'Кредиты Mutantcat AI исчерпаны. Пополните баланс на mutantcat.ai/pricing и повторите попытку',
