...
export const it = {
  ...
  aiMutantcatAccount: 'Account Mutantcat AI',
  aiAccountChecking: 'Verifica in corso…',
  aiLoggedIn: 'Accesso effettuato',
  aiLoggedInAs: 'Accesso effettuato: {email}',
  aiNotLoggedIn: 'Accesso non effettuato (le funzioni IA richiedono un account Mutantcat AI)',
  ...
  aiCreditsExhausted:
    'I tuoi crediti Mutantcat AI sono esauriti. Ricarica su mutantcat.ai/pricing e riprova',
