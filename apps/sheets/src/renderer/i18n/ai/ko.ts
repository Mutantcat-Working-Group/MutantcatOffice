...
export const ko = {
  ...
  aiMutantcatAccount: 'Mutantcat AI 계정',
  aiAccountChecking: '확인 중…',
  aiLoggedIn: '로그인됨',
  aiLoggedInAs: '로그인됨: {email}',
  aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 Mutantcat AI 계정 로그인이 필요합니다)',
  ...
  aiCreditsExhausted:
    'Mutantcat AI 크레딧을 모두 사용했습니다. mutantcat.ai/pricing에서 충전한 후 다시 시도해 주세요',
