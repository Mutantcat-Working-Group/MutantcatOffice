...
export const th = {
  ...
  aiMutantcatAccount: 'บัญชี Mutantcat AI',
  aiAccountChecking: 'กำลังตรวจสอบ…',
  aiLoggedIn: 'ลงชื่อเข้าใช้แล้ว',
  aiLoggedInAs: 'ลงชื่อเข้าใช้แล้ว: {email}',
  aiNotLoggedIn: 'ยังไม่ได้ลงชื่อเข้าใช้ (ฟีเจอร์ AI ต้องใช้บัญชี Mutantcat AI)',
  ...
  aiCreditsExhausted:
    'เครดิต Mutantcat AI ของคุณหมดแล้ว โปรดเติมเครดิตที่ mutantcat.ai/pricing แล้วลองใหม่',
