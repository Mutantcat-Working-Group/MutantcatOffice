...
export const fr = {
  ...
  aiMutantcatAccount: 'Compte Mutantcat AI',
  aiAccountChecking: 'Vérification…',
  aiLoggedIn: 'Connecté',
  aiLoggedInAs: 'Connecté : {email}',
  aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte Mutantcat AI)',
  ...
  aiCreditsExhausted:
    'Vos crédits Mutantcat AI sont épuisés. Rechargez sur mutantcat.ai/pricing puis réessayez',
