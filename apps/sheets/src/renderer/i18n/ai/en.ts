...
export const en = {
  ...
  aiNotLoggedIn: 'Not signed in (AI features require a Mutantcat AI account)',
  ...
  aiCreditsExhausted:
    'Your Mutantcat AI credits have run out. Visit mutantcat.ai/pricing to top up, then try again',
