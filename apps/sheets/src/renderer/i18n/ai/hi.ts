...
export const hi = {
  ...
  aiMutantcatAccount: 'Mutantcat AI खाता',
  aiAccountChecking: 'जांच हो रही है…',
  aiLoggedIn: 'साइन इन किया गया',
  aiLoggedInAs: 'साइन इन: {email}',
  aiNotLoggedIn: 'साइन इन नहीं है (AI सुविधाओं के लिए Mutantcat AI खाता आवश्यक है)',
  ...
  aiCreditsExhausted:
    'आपके Mutantcat AI क्रेडिट समाप्त हो गए हैं। mutantcat.ai/pricing पर रिचार्ज करें और फिर से प्रयास करें',
