...
export const id = {
  ...
  aiMutantcatAccount: 'Akun Mutantcat AI',
  aiAccountChecking: 'Memeriksa…',
  aiLoggedIn: 'Sudah masuk',
  aiLoggedInAs: 'Sudah masuk: {email}',
  aiNotLoggedIn: 'Belum masuk (fitur AI memerlukan akun Mutantcat AI)',
  ...
  aiCreditsExhausted:
    'Kredit Mutantcat AI Anda telah habis. Isi ulang di mutantcat.ai/pricing lalu coba lagi',
