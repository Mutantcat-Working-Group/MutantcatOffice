...
export const pt = {
  ...
  aiMutantcatAccount: 'Conta Mutantcat AI',
  aiAccountChecking: 'Verificando…',
  aiLoggedIn: 'Conectado',
  aiLoggedInAs: 'Conectado: {email}',
  aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta Mutantcat AI)',
  ...
  aiCreditsExhausted:
    'Seus créditos Mutantcat AI acabaram. Recarregue em mutantcat.ai/pricing e tente novamente',
