...
export const nl = {
  ...
  aiMutantcatAccount: 'Mutantcat AI-account',
  aiAccountChecking: 'Controleren…',
  aiLoggedIn: 'Aangemeld',
  aiLoggedInAs: 'Aangemeld: {email}',
  aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een Mutantcat AI-account)',
  ...
  aiCreditsExhausted:
    'Je Mutantcat AI-credits zijn op. Waardeer op via mutantcat.ai/pricing en probeer het opnieuw',
