...
import { ADDABLE_SHAPE_TYPES } from '@mutantcatoffice/xlsx-gateway/shared/shape-types'
import {
...
} from '@mutantcatoffice/xlsx-gateway/shared/edit-schemas'
import type {
  AiChatRequest,
  AiChatResponse,
  AiSettings,
...
// ---- AI settings + chat/stream: canonical types live in @mutantcatoffice/ai-provider,
...
export interface DesktopApi {
  ...
  /// AI image generation (sheets-owned channel)
