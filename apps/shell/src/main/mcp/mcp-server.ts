...
/**
 * Local MCP server for MutantcatOffice.
 *
...
export class McpServerService {
  ...
  private createSessionServer(): McpServer {
    const server = new McpServer({ name: 'MutantcatOffice', version: this.version })
   ...
   * reads as a MutantcatOffice bug. Answers the JSON-RPC parse error itself and
