...
import type { AiProviderId } from '@mutantcatoffice/ai-provider'
...
// hand-traced Mutantcat mark, OpenCode's pixel-block favicon glyph and a
...
// (OpenAI, Kimi, Grok, OpenRouter, Requesty, Opper, OpenCode, Mutantcat, Custom) use
