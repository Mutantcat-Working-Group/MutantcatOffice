...
import logoLockup from './assets/mutantcatoffice-logo.svg'
...
import { useDismissablePopover } from '@mutantcatoffice/ui'
    ...
    <div className="home">
      <aside className="sidebar">
        <div className="sidebar-logo">
          <img className="logo-lockup" src={logoLockup} alt="MutantcatOffice" />
        </div>
        ...
        <div className="account-entry">
          <button
            ...
            onClick={() => setSettingsRequest({ section: 'general' })}
      ...
      {settingsRequest && (
        <SettingsModal
          ...
          onFileSearchChange={() => setRerankSettingsTick((n) => n + 1)}
        />
      )}
