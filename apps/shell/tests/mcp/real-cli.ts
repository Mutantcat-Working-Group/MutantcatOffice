import { runCli } from '@mutantcatoffice/cli'
import type {
  CliRunner,
  CliRunOutcome,
  CliJsonOk,
...
/**
 * A CliRunner backed by the real `@mutantcatoffice/cli` running in-process.
 *
 ...
 * process or depending on a built `dist/mutantcatoffice.cjs`, so it works in CI under
