...
export const VISUAL_SIGNATURE_CONTENT_PREFIX = 'MutantcatOffice visual signature field: '
...
export type DrawingInput =
  ...
  | {
      ...
      at: [number, number]
      contents: string
      /** Annotation author (/T); omitted → 'MutantcatOffice' */
      author?: string
...
/** Editable metadata for a MutantcatOffice static form fill embedded as a page image. */
...
/** Extract pages into a new PDF written to the MutantcatOffice save dir and opened in a new tab */
 ...
 * MutantcatOffice save dir and opened in a new tab */
...
export interface PdfApi {
  ...
  /** Read MutantcatOffice static-fill metadata stored inside the PDF. */
