import { streamText, type AgentMessage, type AgentTransport } from '@mutantcatoffice/agent-core'
 ...
 * the gateway cuts as an idle connection (observed: 4.6k chars, 64 s
...
const SYSTEM = [
  'You are the brief writer of MutantcatOffice HTML, a design-first editor for single-file HTML pages. From the conversation transcript you receive, draft the brief the user will confirm before the system writes the page.',
  '',
  '## The brief',
