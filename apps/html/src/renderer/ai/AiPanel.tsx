...
import { AgentLoop, composeSkills } from '@mutantcatoffice/agent-core'
import type { AgentImage } from '@mutantcatoffice/agent-core'
...
/** Mutantcat brand mark, inline for crisp device-resolution rendering */
