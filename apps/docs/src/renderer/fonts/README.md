...
to the same faces) and are referenced here as `@mutantcatoffice/ui/fonts/Carlito-*.ttf`.
...
The serif subset also backs the `MutantcatOffice Fullwidth TC` face (`fonts.css`), a
...
| Font                                       | Role                                                        |
| ------------------------------------------ | ----------------------------------------------------------- |
| MutantcatOffice Serif KR (subset woff2)    | Batang-metric stand-in for Korean serif families            |
| MutantcatOffice Sans KR (subset woff2)     | fallback for Korean sans families (Malgun etc.)             |
| MutantcatOffice Che Latin KR (ASCII woff2) | half-width Latin for BatangChe/GulimChe/DotumChe/GungsuhChe |
...
`MutantcatOfficeCheLatinKR.woff2` is an ASCII-only derivative of MutantcatOffice Sans KR.
...
| Font                                     | Role                                            |
| ---------------------------------------- | ----------------------------------------------- |
| MutantcatOffice Gothic KR (subset woff2) | real-metric face for NanumGothic-declaring docs |
...
`MutantcatOfficeGothicKR-Regular-subset.woff2`. Renamed per OFL (the upstream
...
### MutantcatOffice UI Kana JP

| Font                                            | Role                                                |
| ----------------------------------------------- | --------------------------------------------------- |
| MutantcatOffice UI Kana JP (Regular/Bold woff2) | Meiryo UI-advance kana/JP punctuation for the alias |
...
| Font                                   | Role                                 |
| -------------------------------------- | ------------------------------------ |
| MutantcatOffice Poppins (subset woff2) | real face for Poppins-declaring docs |
...
checked in as `MutantcatOfficePoppins-{Regular,Bold}-subset.woff2`. Renamed (no
...
| Font                          | Role                                     |
| ----------------------------- | ---------------------------------------- |
| MutantcatOffice Tamil (woff2) | Latha-metric stand-in for Tamil families |
...
| Font                                    | Role                                             |
| --------------------------------------- | ------------------------------------------------ |
| MutantcatOffice PUA Blank (woff2, 312B) | blank 1em glyph for all of U+E000-F8FF (BMP PUA) |
