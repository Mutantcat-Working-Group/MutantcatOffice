...
import { configureMetricsCache, familyVerticalMetrics } from '@mutantcatoffice/font-metrics'
import { createI18n, getUiLang, normalizeLang, setUiLang } from '@mutantcatoffice/i18n'
import { ProjectStore } from '@mutantcatoffice/project-store'
import type {
  IpcMainInvokeEvent,
...
} from '@mutantcatoffice/ai-provider/codex-app-server'
import { listCustomModelsForIpc } from '@mutantcatoffice/ai-provider/custom-models'
import {
  generateImageTool,
  testSearchProvider,
  webSearchTool,
...
const tMain = createI18n({
  zh: {
    ...
    menuHelp: '帮助',
    menuShortcuts: '键盘快捷键',
    menuDocsHelp: 'MutantcatOffice Docs 帮助',
  },
  en: {
    ...
    menuDocsHelp: 'MutantcatOffice Docs Help',
  },
  ja: {
    dlgOpenDoc: '文書を開く',
    filterWord: 'Word 文書',
    ...
    menuDocsHelp: 'MutantcatOffice Docs ヘルプ',
  },
  ko: {
    dlgOpenDoc: '문서 열기',
    filterWord: 'Word 문서',
    ...
    menuDocsHelp: 'MutantcatOffice Docs 도움말',
  },
  fr: {
    ...
    menuDocsHelp: 'Aide MutantcatOffice Docs',
  },
  de: {
    ...
    menuDocsHelp: 'MutantcatOffice Docs-Hilfe',
  },
  es: {
    ...
    menuDocsHelp: 'Ayuda de MutantcatOffice Docs',
  },
  th: {
    ...
    menuDocsHelp: 'วิธีใช้ MutantcatOffice Docs',
  },
  id: {
    ...
    menuDocsHelp: 'Bantuan MutantcatOffice Docs',
  },
  ru: {
    ...
    menuDocsHelp: 'Справка MutantcatOffice Docs',
  },
  ar: {
    ...
    menuDocsHelp: 'تعليمات MutantcatOffice Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    menuDocsHelp: 'Ajuda do MutantcatOffice Docs',
  },
  it: {
    ...
    menuDocsHelp: 'Guida di MutantcatOffice Docs',
  },
  pl: {
    ...
    menuDocsHelp: 'Pomoc MutantcatOffice Docs',
  },
  cs: {
    ...
    menuDocsHelp: 'Nápověda MutantcatOffice Docs',
  },
  nl: {
  ...
  he: {
    ...
    menuDocsHelp: 'עזרה של MutantcatOffice Docs',
  },
  hi: {
    ...
    menuDocsHelp: 'MutantcatOffice Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    menuHelp: '說明',
    menuShortcuts: '鍵盤快速鍵',
    menuDocsHelp: 'MutantcatOffice Docs 說明',
  },
})
...
/** default folder where new files land on their first (silent) save; shared with the other editors via shell. User-configurable (app-settings.json), falls back to <Documents>/MutantcatOffice. */
...
/** office/pdf formats get text extracted via @mutantcatoffice/file-parse; images skip extraction and go multimodal (files:read-image) */
...
/** parse an attachment to text via @mutantcatoffice/file-parse (docx/pdf/pptx/xlsx/plain text) */
...
// implementations live in @mutantcatoffice/ai-provider, shared with apps/sheets.
...
export function registerAiIpc(): void {
  ...
  // provider when one is configured, otherwise the CLI behind its login gate.
  ...
  ipcMain.handle('ai:search-test', (_event, input: unknown) => {
    ...
    if (!provider) {
      return { ok: false, error: 'No search provider selected' }
    }
...
export function startDocsStandalone(): void {
  ...
  // the installed MutantcatOffice Docs is open and forwards its argv there instead.
  ...
  else if (isDev) app.setPath('userData', join(app.getPath('appData'), 'MutantcatOffice Docs Dev'))
