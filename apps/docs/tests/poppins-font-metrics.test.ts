...
const regular = readWoff2(join(FONTS, 'MutantcatOfficePoppins-Regular-subset.woff2'))
const bold = readWoff2(join(FONTS, 'MutantcatOfficePoppins-Bold-subset.woff2'))

describe('MutantcatOffice Poppins (real-metric M365 cloud face)', () => {
