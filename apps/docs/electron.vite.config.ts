...
const localAlias = {
  '@mutantcatoffice/docx-engine/lazy-media': resolve(
    __dirname,
    '../../packages/docx-engine/src/lazy-media.ts',
  ),
  '@mutantcatoffice/docx-engine/zip-splice': resolve(
    __dirname,
    '../../packages/docx-engine/src/zip-splice.ts',
  ),
  '@mutantcatoffice/docx-engine': resolve(__dirname, '../../packages/docx-engine/src/index.ts'),
}
...
export default defineConfig({
  ...
  // @mutantcatoffice/* deps ship as raw TS source with extensionless imports, so they
