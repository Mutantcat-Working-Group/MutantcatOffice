import { imageSearchTool, webSearchTool } from '@mutantcatoffice/ai-search'
...
export const searchCommand: CommandDef = {
  name: 'search',
  summary:
    'Web or image search through the provider configured in MutantcatOffice (Mutantcat AI, Serper, Tavily, Parallel).',
