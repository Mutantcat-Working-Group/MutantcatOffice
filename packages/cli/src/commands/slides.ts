...
import { parseOutline } from '@mutantcatoffice/pipelines/slides'
...
export const slidesCommand: CommandDef = {
  ...
  options: [
    ...
    { name: 'out', value: 'path', description: 'apply: write here instead of in place' },
    {
      name: 'force',
      description:
        'apply: overwrite an existing --out file, or write while MutantcatOffice has the file open',
    },
    {
      name: 'page',
      value: 'n',
...
/** One PNG per slide, through the app's PDF export (hidden MutantcatOffice process) and pdfium. */
