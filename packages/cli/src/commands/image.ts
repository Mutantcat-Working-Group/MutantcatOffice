...
export const imageCommand: CommandDef = {
  ...
  options: [
    ...
    },
    {
      name: 'size',
      value: 'size',
      description: 'auto | 0.5k | 1k | 2k | 3k | 4k (Mutantcat AI only)',
    },
    {
      name: 'ref',
      value: 'images',
    ...
    },
    {
      name: 'model',
      value: 'name',
      description: 'Mutantcat AI model override (e.g. fal-bria-rmbg)',
    },
...
/** Mutantcat AI returns an https URL, BYOK providers a file:// in the app's generated-image store; fetchRemoteImage serves both. */
