 ...
 */
import type { Fill, Stroke, ShadowEffect } from '@mutantcatoffice/pptx-engine'
...
export function resolveGlow(
  glow: import('@mutantcatoffice/pptx-engine').GlowEffect | undefined,
  vp: Viewport,
...
export function resolveReflection(
  reflection: import('@mutantcatoffice/pptx-engine').ReflectionEffect | undefined,
  vp: Viewport,
