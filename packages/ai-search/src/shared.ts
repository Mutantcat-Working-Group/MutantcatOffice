/** Search result types and shared constants (used by both the index and cloud backends) */
 ...
 * proxy via session.resolveProxy); consumed by the login flow's proxy fallback.
 */
