...
const LABELS: Record<string, Labels> = {
  ...
  fr: {
    ...
    help: 'Aide',
    about: 'À propos de MutantcatOffice',
  ...
  es: {
    ...
    help: 'Ayuda',
    about: 'Acerca de MutantcatOffice',
  ...
  th: {
    ...
    help: 'วิธีใช้',
    about: 'เกี่ยวกับ MutantcatOffice',
  ...
  it: {
    ...
    help: 'Aiuto',
    about: 'Informazioni su MutantcatOffice',
  ...
  pl: {
    ...
    help: 'Pomoc',
    about: 'O programie MutantcatOffice',
  ...
  cs: {
    ...
    help: 'Nápověda',
    about: 'O aplikaci MutantcatOffice',
  ...
  hi: {
    ...
    help: 'सहायता',
    about: 'MutantcatOffice के बारे में',
...
export function aboutMenuItem(labels: AppMenuLabels): MenuItemConstructorOptions {
  return {
    ...
    click: async () => {
      ...
      if (response === 1) clipboard.writeText(`MutantcatOffice ${version}`)
